...
@Component({
  selector: 'app-filterpsikolog',
  templateUrl: './filterpsikolog.component.html',
  styleUrls: ['./filterpsikolog.component.scss'],
})
export class FilterpsikologComponent implements OnInit {
  constructor() {}
